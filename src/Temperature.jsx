...
const Temperature = ({weather, temp}) => {
  ...
  return (
    <header className='container max-w-[400px] mx-auto py-8 grid grid-cols-9 grid-rows-[1fr_0.5fr_0.5fr_0.25fr_0.5fr_1fr]'>
      <p className=' px-3 bg-white/40 rounded-full text-black/70 font-bold  col-[7_/_span_3] text-center text-sm my-[1rem]'>9:58 p.m</p>
      ...
      <button onClick={toggleTemp} className=' bg-[#FF2E3C] px-5 py-1 rounded-full flex justify-center items-center row-start-5  col-[7_/_span_3] my-2 gap-2'>
